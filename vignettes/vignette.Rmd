...
# Detailed Tutorial
<!-- ---------------------------------- -->
**Each step of an typical _CellTrails_ analysis workflow is illustrated, described and explained in detail in this [tutorial](https://elldc.github.io/CellTrails/).**
...
The protocol used to analyze this dataset with *CellTrails* can be obtained [here](https://elldc.github.io/CellTrails/#101_protocols).
